...
const ExplorePage = () => {
  ...
  const { data: featuredEvents, loading: loadingFeatured } = useConvexQuery(
  ...
  return (
    <>
      ...
      {/* Browse by category */}
      <div className="mb-16">
        <div className="text-3xl font-bold mb-6">Browse By Category</div>
        ...
        (!popularEvents || popularEvents.length === 0) && (
          <Card className="p-12 text-center">
            <div className="max-w-md mx-auto space-y-4">
              ...
              <h2 className="text-2xl font-bold">No event yet</h2>
              <p className="text-muted-foreground">
